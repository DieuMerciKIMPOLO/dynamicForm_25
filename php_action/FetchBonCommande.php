...
$sql = "SELECT order_id, order_date, NomPrenomLivraison,TelephoneClient,NomPrenomAgent,TelephoneAgent,NumeroMgAgent,total_amount FROM orders WHERE order_status = 1 ORDER BY order_id DESC";

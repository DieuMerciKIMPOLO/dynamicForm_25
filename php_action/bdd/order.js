    ...
    if (divRequest == 'add') {
        ...
        $("#createOrderBtn").click(function(event) {
            $("#createOrderForm").unbind('submit').bind('submit', function() {
                //$("#createOrderForm").unbind('click').bind('click', function() {
                ...
                if (tables <= 0) {
                    $('#row36').closest('.row36').addClass('has-error');
                    $('#row37').closest('.row37').addClass('has-error');
                ...
                if (quantite14 == 0) {
                    ...
                    $("DernierChamp").after('<p class="text-danger text-center"> Au moins 1 qauntité doit être ajouté au produit Meuble de cuisine Hector</p>');
                ...
                /*var QteCheck = document.getElementsByName('QteCheck[]');
                var Famille = document.getElementsByName('Famille[]');

                for (var x = 0; x < (QteCheck.length) && (Famille.length); x++) {
                    var QteCheckId = QteCheck[x].value;
                    var FamilleId = Famille[x].value;

                    if (QteCheckId == FamilleId) {
                        $("#" + QteCheckId + "").after('<p class="text-danger"> Nom produit obligatoire!! </p>');
                        $("#" + QteCheckId + "").closest('.form-group').addClass('has-error');
                    } else {
                        $("#" + QteCheckId + "").closest('.form-group').addClass('has-success');
                    }
                }*/
                ...
                /*for (var x = 0; x < checkName.length; x++) {
                    var checkNameId = checkName[x].id;
    ...
    if (orderId) {
        ...
        $.ajax({
            ...
            success: function(response) {
                    ...
                    var mywindow = window.open('', 'LOGICOM 1.0', 'height=1000,width=900');
                    mywindow.document.write('<html><head><title>FACTURE COMMERCIALE</title>');

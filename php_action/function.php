...
{
	$query = "
	SELECT * FROM category WHERE category_status = 'active' ORDER BY category_name ASC
	";
...
function get_user_wise_total_order($connect)
{
	...
	<div class="table-responsive">
		<table class="table table-bordered table-striped">
			<tr>
				<th>Utilisateur</th>
				<th>Total Montant Commande</th>
				<th>Total Commande Espèce </th>
				<th>Total Commande Crédit</th>
			</tr>
	';
	...
	foreach($result as $row)
	{
		...
		<tr>
			<td>'.$row['user_name'].'</td>
			<td align="right">'.$row["order_total"].' FCFA</td>
			<td align="right">'.$row["cash_order_total"].' FCFA</td>
			<td align="right">'.$row["credit_order_total"].' FCFA</td>
		</tr>
		';
	...
	<tr>
		...
		<td align="right"><b>'.$total_order.' FCFA</b></td>
		<td align="right"><b>'.$total_cash_order.' FCFA</b></td>
		<td align="right"><b>'.$total_credit_order.' FCFA</b></td>
	</tr></table></div>
	';
	return $output;
}

...
$(document).ready(function() {
    ...
    $("#addClientModalBtn").unbind('click').bind('click', function() {
        ...
        $("#submitClientForm").unbind('submit').bind('submit', function() {
            ...
            // form validation
            var clientImage = $("#clientImage").val();
            ...
            if (clientImage == "") {
                $("#clientImage").closest('.center-block').after('<p class="text-danger">Image client obligatoire</p>');
                $('#clientImage').closest('.form-group').addClass('has-error');
            } else {
                // remov error text field
                $("#clientImage").find('.text-danger').remove();
                // success out for form 
                $("#clientImage").closest('.form-group').addClass('has-success');
            } // /else
            ...
            if (productStatus == "") {
                $("#productStatus").after('<p class="text-danger">Statut client obligatoire</p>');
    ...
    if (clientId) {
        ...
        $.ajax({
            ...
            success: function(response) {
                    ...
                    $("#getClientImage").attr('src', 'stock/' + response.client_image);

                    $("#editClientImage").fileinput({});
                    ...
                    // update the client data function
                    $("#editProductForm").unbind('submit').bind('submit', function() {
                        ...
                        if (productName == "") {
                            $("#editProductName").after('<p class="text-danger">Client Name field is required</p>');
                        ...
                        if (productStatus == "") {
                            $("#editProductStatus").after('<p class="text-danger">Statut client obligatoire</p>');
                    ...
                    $("#updateProductImageForm").unbind('submit').bind('submit', function() {
                        ...
                        if (productImage == "") {
                            $("#editProductImage").closest('.center-block').after('<p class="text-danger">Image client obligatoire</p>');
...
// remove client 
function removeProduct(clientId = null) {
    if (productId) {
        ...
        $("#removeProductBtn").unbind('click').bind('click', function() {
            ...
            }); // /ajax fucntion to remove the client
            return false;
        }); // /remove client btn clicked
    } // /if productid

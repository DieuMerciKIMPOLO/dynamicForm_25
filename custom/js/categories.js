...
$(document).ready(function() {
    ...
    $('#addCategoriesModalBtn').unbind('click').bind('click', function() {
        ...
        $("#submitCategoriesForm").unbind('submit').bind('submit', function() {
            ...
            var QteCheck = $("#QteCheck").val();

            if (categoriesName == "") {
                $("#categoriesName").after('<p class="text-danger">Nom Famille obligatoire</p>');
            ...
            if (QteCheck == "") {
                $("#QteCheck").after('<p class="text-danger">Qauntité default obligatoire</p>');
                $('#QteCheck').closest('.form-group').addClass('has-error');
            } else {
                // remov error text field
                $("#QteCheck").find('.text-danger').remove();
                // success out for form 
                $("#QteCheck").closest('.form-group').addClass('has-success');
            }

            if (categoriesName && QteCheck) {
                var form = $(this);
                // button loading
    ...
    if (categoriesId) {
        ...
        $.ajax({
            ...
            success: function(response) {
                    ...
                    $("#editQteCheck").val(response.QteCheck);
                    ...
                    $("#editCategoriesForm").unbind('submit').bind('submit', function() {
                        ...
                        var QteCheck = $("#editQteCheck").val();

                        if (categoriesName == "") {
                            $("#editCategoriesName").after('<p class="text-danger">Nom Famille obligatoire</p>');
                        ...
                        if (QteCheck == "") {
                            $("#editQteCheck").after('<p class="text-danger">Quantité default obligatoire</p>');
                            $('#editQteCheck').closest('.form-group').addClass('has-error');
                        } else {
                            // remov error text field
                            $("#editQteCheck").find('.text-danger').remove();
                            // success out for form 
                            $("#editQteCheck").closest('.form-group').addClass('has-success');
                        }
